...
export default function PurchaseOrderEditPanel({ po }: { po: PurchaseOrder }) {
      ...
      {!open ? (
        ...
        <form onSubmit={handleSave} style={{ background: c.panel, border: `1px solid ${c.line}`, borderRadius: 12, padding: 16 }}>
          ...
          <div style={fw}>
            ...
            <input style={inp} type="date" value={form.order_date} onChange={set("order_date")} />
          </div>
          <div style={fw}>
            <label style={lbl}>Expected delivery</label>
            <input style={inp} type="date" value={form.expected_date} onChange={set("expected_date")} />
          </div>
          <div style={fw}>
