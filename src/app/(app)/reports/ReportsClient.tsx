...
const METRIC_META: Record<AnalyticsMetricId, { label: string; feature?: keyof TenantFeatures; workcenter?: WorkcenterKey }> = {
  // Core-module metrics also carry their 0067 feature flag: workcenter
  // visibility alone doesn't stop a tenant ADMIN (who sees every
  // workcenter) from getting CRM widgets in a module the tenant never
  // bought (e.g. a WFM-only workspace).
  accounts:               { label: "Accounts KPI",         feature: "accounts", workcenter: "accounts" },
  ...
  technicians:            { label: "Technicians KPI",      feature: "technicians", workcenter: "technicians" },
  accounts_by_type:       { label: "Accounts by type",     feature: "accounts", workcenter: "accounts" },
  lead_funnel:            { label: "Lead pipeline funnel", feature: "leads",    workcenter: "leads" },
  assets_by_kind:         { label: "Assets by kind",       feature: "assets", workcenter: "assets" },
  quote_trend:            { label: "Quote value trend",     feature: "quotations", workcenter: "quotations" },
  case_status:            { label: "Case status bars",      feature: "cases", workcenter: "cases" },
  work_order_status:      { label: "Work orders by status", feature: "work_orders", workcenter: "work_orders" },
  technician_availability:{ label: "Technician availability", feature: "technicians", workcenter: "technicians" },
