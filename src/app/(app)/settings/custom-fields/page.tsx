...
type ObjectType = "account" | "contact" | "case" | "quote" | "work_order" | "asset" | "supplier" | "inventory" | "purchase_order" | "invoice" | "employee" | "product" | "project" | "opportunity";
...
const OBJECTS: { key: ObjectType; label: string; icon: string; featureKey: keyof TenantFeatures }[] = [
  ...
  { key: "product",        label: "Product",         icon: "▩", featureKey: "products" },
  ...
  { key: "opportunity",    label: "Deal (pipeline)",     icon: "◈", featureKey: "pipeline" },
];
...
export default function CustomFieldsPage() {
  ...
  return (
    <div style={{ maxWidth: 720 }}>
      ...
      {/* Header */}
      <div className="bpm-page-header" style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 20 }}>
        <div>
