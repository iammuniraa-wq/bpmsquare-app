...
const SECTIONS: { group: string; items: SettingsCard[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Pricing", description: "Dynamic pricing: pick how you price, set your numbers, go live — has its own workcenter with rates, setup wizard, history and an advanced config cockpit", href: ROUTES.pricingSetup, icon: "◬", pillarKey: "amber", adminOnly: true, featureKey: "pricing_engine", relatedWorkcenter: "pricing" },
