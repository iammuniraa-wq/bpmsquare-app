...
// Mirrors src/app/api/suppliers/[id]/route.ts PATCH.
const ALLOWED = ["name", "type", "city", "phone", "email", "gstin", "notes", "status", "custom_data"];
...
export async function POST(request: NextRequest) {
  ...
  return NextResponse.json(await updateRows(supabase, "suppliers", tenantId, prepared, outcomes));
}
