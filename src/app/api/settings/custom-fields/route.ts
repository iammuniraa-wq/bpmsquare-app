...
const VALID_OBJECTS = ["account", "contact", "case", "quote", "work_order", "asset", "supplier", "inventory", "purchase_order", "invoice", "employee", "product", "project", "opportunity"] as const;
