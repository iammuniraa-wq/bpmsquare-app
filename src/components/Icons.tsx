...
type P = { size?: number; color?: string; style?: React.CSSProperties; className?: string };

function Svg({ size = 16, color = "currentColor", style, className, children }: P & { children: React.ReactNode }) {
  return (
    <svg
      width={size}
      height={size}
...
export function Phone(p: P) {
  return (
    <Svg {...p}>
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.41 2 2 0 0 1 3.6 1.24h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.91a16 16 0 0 0 6.29 6.29l.95-.95a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7a2 2 0 0 1 1.72 2.02z" />
    </Svg>
  );
}
...
export function CalendarCheck(p: P) {
  return (
    <Svg {...p}>
...
export function StarFilled(p: P) {
  return (
    <Svg {...p} style={{ ...p.style }}>
      <polygon
...
export function StarOutline(p: P) {
  return (
    <Svg {...p}>
...
export function AlertTriangle(p: P) {
  return (
    <Svg {...p}>
