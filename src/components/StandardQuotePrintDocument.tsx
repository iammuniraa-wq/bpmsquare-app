import type { StandardQuote, StandardQuoteLine, Account, Contact } from "@/lib/types";
...
// draws from -- that's tenant branding config, not object-specific.
export default function StandardQuotePrintDocument({
  quote, lines, account, contact, companyInfo = {}, logoUrl,
  ...
  return (
    <div className="doc">
      ...
      <div style={{ background: "#fff", borderBottom: `2px solid ${brand.dark}`, breakInside: "avoid" }}>
        <div style={{ padding: "10px 22px 9px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div>
              <div style={{ fontSize: 20, fontWeight: 900, color: brand.dark, letterSpacing: 0.4, lineHeight: 1.15 }}>
                {co.name}
              </div>
              {co.tagline && (
      ...
      <div style={{ padding: "11px 28px", borderBottom: `1px solid ${brand.line}`, breakInside: "avoid" }}>
        <SectionLabel>Quote for</SectionLabel>
        {account ? (
          <>
            ...
            <tr>
              <td colSpan={2} style={{ paddingTop: 6 }}>
                <div style={{ background: brand.dark, color: "#fff", borderRadius: 6, padding: "8px 14px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <span style={{ fontSize: 16, fontWeight: 700, color: brand.amber }}>{inr(total)}</span>
                </div>
              </td>
            </tr>
          </tbody>
